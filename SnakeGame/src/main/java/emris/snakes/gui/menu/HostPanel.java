...
public class HostPanel extends JPanel {
    ...
    private static final @NotNull Border NORMAL_TEXT_FIELD_BORDER = BorderFactory.createCompoundBorder(
    ...
    private static final @NotNull Border ERROR_TEXT_FIELD_BORDER = BorderFactory.createCompoundBorder(
            BorderFactory.createMatteBorder(4, 2, 4, 2, Colours.INTERFACE_BACKGROUND),
            BorderFactory.createCompoundBorder(
    ...
    HostPanel(
        ...
        val config = ConfigData.copyOf(baseConfig);
    ...
    private static <T extends Number> @NotNull JTextField createTextArea(
    ...
    private static <T extends Number> @NotNull String createTooltip(
            final @NotNull T lowerBound,
            final @NotNull T upperBound) {
        return "From " + lowerBound + " to " + upperBound;
    }

    private static @NotNull JPanel createInputPanel(final @NotNull JTextField textField) {
        val panel = new JPanel(new BorderLayout());
        panel.add(textField, BorderLayout.WEST);
        return panel;
    }

    private static @NotNull JLabel createLabel(final @NotNull String caption) {
    ...
    private static final class ConfigChangeListener<T extends Number> implements DocumentListener {
        ...
        final @NotNull JTextField textField;
        private final @NotNull UnsafeFunction<@NotNull String, @NotNull T> converter;
        private final @NotNull Consumer<@NotNull T> numericValueConsumer;
        private final @NotNull Supplier<@NotNull Boolean> checker;
        private final @NotNull Consumer<@NotNull Boolean> onChanged;
